...
import { getSiteDomain } from './site';
  ...
  return [
    ...
    },
    {
      ...
      steps: [
        ...
        `2. Claim your unique username (e.g., ${domain}/@yourname) or alternative share pattern.`,
    ...
    },
    {
      ...
      content: [
        ...
        `Share your unique referral link (${domain}/r/{code}) to invite friends and fellow creators to LinkVM, with real-time signup tracking directly in your dashboard.`
      ]
    },
    {
      id: 'social-links',
