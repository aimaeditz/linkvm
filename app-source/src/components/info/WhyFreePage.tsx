...
export const WhyFreePage: React.FC<WhyFreePageProps> = ({ onNavigate }) => {
  ...
  const featureCards = [
    ...
    },
    {
      ...
      description:
        'Track every click, view, referral source, and device with precision. Clean privacy-first metrics with no hidden tier restrictions or export paywalls.',
      icon: BarChart3,
    },
    {
  ...
  const billingFaqs = [
    {
      q: 'Will LinkVM ever charge for core features?',
      a: 'No. The core functionality—unlimited links, 34 themes, real-time analytics, and high-res QR codes—will remain 100% free forever for every creator.',
    },
    {
    ...
    {
      q: 'How does LinkVM sustain operations without subscriptions?',
      a: 'We operate with modern lean cloud infrastructure and low server overhead. Because our operational efficiency is so high, we do not need to extract recurring subscription fees from creators.',
    },
    {
      q: 'Are there hidden limits on visitor traffic or page views?',
      a: 'No limits. Whether your page receives ten visits or ten million visits from a viral social post, your LinkVM page stays fast and online.',
    },
    {
    ...
    },
    {
      ...
      a: 'Yes. You have full ownership of your content. You can view, copy, and export your links and information at any time in standard JSON format without fee or lock-in.',
    },
  ];
        ...
        <section className="relative pt-16 pb-20 md:pt-24 md:pb-28 overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="mt-6 text-base sm:text-xl text-slate-600 max-w-2xl mx-auto leading-relaxed">
              We founded LinkVM on the principle that consolidating your digital presence should never come with a monthly subscription tax. Every feature is unlocked for everyone, forever.
            </p>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-2xl mx-auto mb-16">
              ...
              <p className="text-sm sm:text-base text-slate-600 mt-2">
                Compare what other platforms lock behind expensive monthly fees with what LinkVM delivers for free.
              </p>
            </div>
        ...
        <section className="py-16 bg-slate-50/70 border-y border-slate-100">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="mt-4 text-sm sm:text-base text-slate-600 leading-relaxed">
              We leverage modern client-side architectures and lean hosting infrastructure that cost pennies per million requests. Because our operational efficiency is so high, we do not need to extract recurring subscription fees from creators. The core product is and will always remain completely free.
            </p>
          </div>
        </section>
