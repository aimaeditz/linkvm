  ...
  return (
    <footer className="w-full bg-white border-t border-slate-100 py-10 md:py-12 select-none">
      ...
      >
        ...
        {/* Bottom Bar: Logo & Copyright on Left, divider, then single centered line */}
        <div className="border-t border-slate-100 mt-8 pt-6">
          <div className="flex flex-col items-start gap-2">
            <Logo size="sm" showSubtitle={true} />
            <div className="mt-2 leading-tight text-xs space-y-1">
              <div className="text-slate-500">© 2026 LinkVM. All rights reserved.</div>
              <div className="text-slate-400 font-normal">Created by AiMAEditz</div>
            </div>
          </div>

          <div className="border-t border-slate-100/80 mt-6 pt-4 text-center">
            <span className="text-xs text-slate-400">
              100% Free Forever. Zero trackers. High performance.
            </span>
          </div>
        </div>
      </motion.div>
