...
export const Hero: React.FC<HeroProps> = ({ onStartFree, onSeeHowItWorks }) => {
  ...
  return (
    <section className="relative overflow-hidden pt-24 md:pt-28 lg:pt-32 pb-20 md:pb-28 bg-white w-full">
      {/* Background blurred gradient orbs + light dotted grid overlay at 15% opacity */}
      <div
        aria-hidden="true"
      ...
      <div className="w-full px-6 md:px-10 lg:px-16 xl:px-24 2xl:px-32">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          {/* Left Column: Headline, subhead, dual CTAs, micro-copy, trust chips */}
          <div className="lg:col-span-6 flex flex-col items-center lg:items-start text-center lg:text-left">
            ...
            {/* Display Heading (56-64px desktop) */}
            <motion.h1
            ...
            >
              {/* Start Free (gradient primary with arrow) */}
              <button
                type="button"
                onClick={handleStart}
              ...
              {/* See How It Works (outline with play icon) */}
              <button
                type="button"
          ...
          {/* Right Column: Clean Centered Profile Card Alone with Concentric Rings */}
          <div className="lg:col-span-6 flex flex-col items-center justify-center relative select-none">
            ...
            {/* Container for Concentric Circles & Profile Card & Orbiting Icons */}
            <div
            ...
            >
              {/* Soft Concentric Ring Pattern Centered Behind Card */}
              <svg
                aria-hidden="true"
              ...
              {/* Center CSS Profile Card (FloatY Animation) */}
              <motion.div
              ...
              >
                {/* Gradient ring avatar with neutral text 'you' */}
                ...
                {/* Short URL Footer Inside Card: linkvm.online/yourhandle */}
