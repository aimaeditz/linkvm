    ...
    <div className="min-h-screen bg-white text-slate-900 flex flex-col font-sans selection:bg-indigo-500 selection:text-white">
      ...
      <main className="flex-1 py-16 md:py-24">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Privacy Core Commitment Banner */}
          ...
          <div className="space-y-10 text-slate-700 text-sm sm:text-base leading-relaxed">
            <section className="space-y-3">
              ...
              <p>
                When you create an account on LinkVaultMe, we collect:
              </p>
            ...
            <section className="space-y-3">
              ...
              <ul className="list-disc pl-6 space-y-1 text-slate-600 text-sm">
                <li>Render your public LinkVaultMe page when visitors navigate to your unique URL.</li>
            ...
            <section className="space-y-3">
              ...
              <p>
                We use essential first-party cookies and browser local storage strictly for authentication session tokens and client-side preferences (such as remembering your active tab or dark/light display mode). We do not deploy third-party advertising cookies or cross-site tracking beacons.
              </p>
            </section>
            ...
            <section className="space-y-3">
              ...
              <p>
                We do not sell, rent, or trade your personal information to data brokers or advertising exchanges under any circumstance. We only utilize trusted cloud hosting infrastructure providers to serve encrypted web traffic and store database backups under strict security compliance.
              </p>
            </section>
            ...
            <section className="space-y-3">
              ...
              <ul className="list-disc pl-6 space-y-1 text-slate-600 text-sm">
                ...
                <li>Request permanent account deletion and complete erasure of all associated server logs.</li>
                <li>Export your profile information in standard machine-readable formats.</li>
              </ul>
            </section>
            ...
            <section className="space-y-3">
              ...
              <p>
                We retain your account details as long as your LinkVaultMe account remains active. If you elect to delete your account via the settings dashboard, all personal profiles, stored links, and private logs are permanently removed from production databases.
              </p>
            </section>
            ...
            <section className="space-y-3">
              ...
              <p>
                For questions regarding this privacy policy or to submit a data erasure request, please contact our privacy compliance team directly at:
              </p>
              <p className="font-semibold text-indigo-600">
                privacy@linkvaultme.com
              </p>
            </section>
          </div>
        </div>
