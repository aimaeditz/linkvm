  ...
  return (
    <div className="min-h-screen bg-white text-slate-900 flex flex-col font-sans selection:bg-indigo-500 selection:text-white">
      ...
      <main className="flex-1">
        ...
        <section className="relative pt-16 pb-20 md:pt-24 md:pb-28 overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="mt-6 text-base sm:text-xl text-slate-600 max-w-2xl mx-auto leading-relaxed">
              LinkVaultMe exists to replace bloated, subscription-gated bio link tools with a fast, pristine, and forever-free alternative built with world-class engineering standards.
            </p>
        ...
        {/* Why We Started LinkVaultMe (Prose narrative) */}
        <section className="py-16 md:py-24 bg-white">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 tracking-tight pb-3 border-b-2 border-indigo-600/30 mb-8 inline-block">
              Why we started LinkVaultMe
            </h2>

            <div className="space-y-6 text-slate-600 text-base leading-relaxed">
              <p>
                In an era where every basic digital utility has been turned into a $12/month recurring subscription, creating a simple link-in-bio page had become unnecessarily expensive and frustratingly complex. Creators were forced to endure degraded mobile interfaces, artificial theme limits, and aggressive upsell banners just to share their work.
              </p>
              ...
              <p>
                Every feature in LinkVaultMe is designed from scratch with modern frontend principles: serverless edge caching, SVG iconography, zero third-party telemetry, and instant debounced auto-saving. You never lose changes, and your visitors never wait for your page to load.
              </p>

              <p>
                By keeping our architecture clean and our infrastructure costs negligible, we guarantee that the core LinkVaultMe experience will remain free forever for every creator on the web.
              </p>
            </div>
            ...
            <div className="mt-16 text-center pt-8 border-t border-slate-100">
              ...
              >
                <span>Join LinkVaultMe Free</span>
                <ArrowRight
                  size={18}
