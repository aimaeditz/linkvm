        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-10 text-slate-700 text-sm sm:text-base leading-relaxed">
            <section className="space-y-3">
              ...
              <p>
                By registering for an account, accessing, or using LinkVaultMe (&ldquo;the Service&rdquo;), you agree to be bound by these Terms of Service. If you do not agree to these terms, you must discontinue use of the Service immediately.
              </p>
            </section>
            ...
            <section className="space-y-3">
              ...
              <p>
                LinkVaultMe is intended for sharing legitimate professional, creative, personal, and commercial links. You agree NOT to use the Service to:
              </p>
            ...
            <section className="space-y-3">
              ...
              <p>
                You retain complete ownership of all content, titles, bios, and links you publish through LinkVaultMe. You grant us a limited, worldwide license solely to store, display, and transmit your public profile on your behalf.
              </p>
            </section>
            ...
            <section className="space-y-3">
              ...
              <p>
                To the fullest extent permitted by applicable law, LinkVaultMe and its maintainers shall not be liable for any indirect, incidental, special, consequential, or punitive damages resulting from your use of or inability to access the platform.
              </p>
            </section>
